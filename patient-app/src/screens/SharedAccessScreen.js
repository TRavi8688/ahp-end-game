    ...
    const renderActiveItem = ({ item }) => (
        <View style={styles.activeCard}>
            ...
            <View style={{ flex: 1 }}>
                ...
                <Text style={styles.activeSub}>{item.clinic_name || 'Hospain Network'}</Text>
            </View>
    ...
    return (
        <View style={styles.container}>
            <LinearGradient colors={['#4c1d95', '#7c3aed']} style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Hospain Sync & Consent</Text>
            </LinearGradient>
...
const styles = StyleSheet.create({
    ...
    approveBtn: { flex: 2, backgroundColor: '#4c1d95', paddingVertical: 12, borderRadius: 14, alignItems: 'center' },
    approveText: { color: '#fff', fontWeight: 'bold', fontSize: 15 },
    rejectBtn: { flex: 1, backgroundColor: '#f3f4f6', paddingVertical: 12, borderRadius: 14, alignItems: 'center' },
    rejectText: { color: '#6b7280', fontWeight: 'bold', fontSize: 15 },
    activeCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', marginHorizontal: 20, padding: 15, borderRadius: 18, marginBottom: 10, borderWidth: 1, borderColor: '#f3f4f6' },
