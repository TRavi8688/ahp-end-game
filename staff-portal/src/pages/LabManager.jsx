...
export default function LabManager() {
  ...
  const fetchOrders = async () => {
    try {
      ...
      const res = await apiClient.get('/api/v1/lab/orders', {
  ...
  const handleFileChange = async (e) => {
    ...
    try {
      ...
      const res = await apiClient.post('/api/v1/lab/upload-report', formData, {
  ...
  const handleSubmitResults = async (e) => {
    ...
    try {
      ...
      await apiClient.post(`/api/v1/lab/orders/${activeOrder.id}/results`, {
        results: resultRows,
  ...
  const handleMarkCollected = async (orderId) => {
    try {
      ...
      await apiClient.post(`/api/v1/lab/orders/${orderId}/results`, {
