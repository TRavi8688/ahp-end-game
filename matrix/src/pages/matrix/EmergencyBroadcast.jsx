  ...
  return (
    <PageShell title="Emergency Broadcast">
      <div style={{ display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", minHeight:400, textAlign:"center" }}>
        ...
        <h2 style={{ fontSize:18, fontWeight:800, color:"#f1f5f9", margin:"0 0 8px" }}>Emergency Broadcast</h2>
        <p style={{ fontSize:13, color:"#475569", maxWidth:420, lineHeight:1.6 }}>System-wide broadcast to hospitals, pharmacies, labs, patients via WhatsApp, SMS, Push.</p>
