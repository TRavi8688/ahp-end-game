 ...
 *   7. Hospyn Team        — create/manage internal Hospyn employees
 *
 * FIXES vs original:
 ...
 *  - Hospyn Team tab → POST /employees/create
      ...
      <motion.div initial={{ scale: 0.96, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-black text-slate-900 text-sm">Create Hospyn Employee</span>
          </div>
...
export default function SovereignConsole({ onLogout }) {
  ...
  const TABS = [
    ...
    { id: 'team',      icon: Users,       label: 'Hospyn Team' },
  ];
    ...
    <div className="flex h-screen bg-slate-50 text-slate-800 font-inter overflow-hidden">
      ...
      <div className="w-64 bg-white border-r border-slate-200 flex flex-col p-5 shadow-sm z-10 shrink-0">
        <div className="flex items-center gap-2 font-black text-xl tracking-tight mb-8">
          ...
          <span>HOSPYN<span className="text-violet-600">.</span></span>
          ...
          <div className="flex justify-between items-end border-b border-slate-200 pb-5 mb-8">
            <div>
              ...
              <p className="text-sm text-slate-400 font-medium mt-1">
                ...
                {activeTab === 'hospitals' && `${hospitals.length} hospitals on the Hospyn network`}
                {activeTab === 'team'      && `${employees.length} Hospyn team members`}
            ...
            <div className="space-y-5">
              ...
              <div className="bg-white border border-slate-100 rounded-3xl shadow-sm overflow-hidden">
                <table className="w-full text-left text-xs">
                  ...
                  <tbody className="divide-y divide-slate-50">
                    {employees.length === 0 && (
                      <tr><td colSpan={7} className="p-10 text-center text-slate-400">No Hospyn employees yet. Create the first one above.</td></tr>
                    )}
                    {employees.map(e => (
