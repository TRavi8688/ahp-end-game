...
export default function Alerts() {
    ...
    const getIconConfig = (type) => {
        switch (type) {
            ...
            default: return { icon: <CheckCircleOutlinedIcon sx={{ color: '#cbd5e1' }} />, bg: '#f3f4f6' };
        }
    };
            ...
            <Card elevation={0} sx={{ border: '1px solid #e5e7eb', borderRadius: 2 }}>
                {alerts.length === 0 ? (
                    <Box sx={{ p: 6, textAlign: 'center' }}>
                        ...
                        <Typography variant="body2" sx={{ color: '#cbd5e1', mt: 1 }}>You have no new notifications or alerts at this time.</Typography>
                    </Box>
                    ...
                    return (
                        ...
                        >
                            ...
                            <Box sx={{ flex: 1 }}>
                                ...
                                <Typography variant="caption" sx={{ fontFamily: 'monospace', color: '#cbd5e1', fontWeight: 'bold' }}>
                                    {alert.time}
                                </Typography>
                            </Box>
