...
export default function PatientList() {
    ...
    const STATUS_OPTIONS = ['all', 'stable', 'urgent', 'followup'];
            ...
            <Box className="glass-card" sx={{ 
                ...
                <Box sx={{ p: 4, display: 'flex', gap: 2, alignItems: 'center' }}>
                    <Box sx={{
                        ...
                        <SearchIcon sx={{ color: '#cbd5e1', mr: 2 }} />
                        <InputBase
                    ...
                    <IconButton
                        onClick={() => {
                            const idx = STATUS_OPTIONS.indexOf(statusFilter);
                            setStatusFilter(STATUS_OPTIONS[(idx + 1) % STATUS_OPTIONS.length]);
                        }}
                        sx={{
                            bgcolor: statusFilter !== 'all' ? 'rgba(13,148,136,0.15)' : 'rgba(255,255,255,0.03)',
                            color: statusFilter !== 'all' ? '#0d9488' : '#fff',
                            borderRadius: '16px', p: 1.8,
                            border: statusFilter !== 'all' ? '1px solid rgba(13,148,136,0.4)' : '1px solid rgba(255,255,255,0.05)',
                ...
                <List sx={{ flex: 1, overflowY: 'auto', p: 0, px: 2 }}>
                    {isLoading ? (
                        <Box sx={{ p: 10, textAlign: 'center' }}>
                            ...
                            <Typography sx={{ color: '#cbd5e1', fontWeight: 700, letterSpacing: 1 }}>SYNCHRONIZING ROSTER...</Typography>
                        </Box>
                            ...
                            <Tooltip title={isRevoked ? "Restricted: Access revoked by subject" : ""} placement="right" key={patient.hospyn_id}>
                                ...
                                >
                                    ...
                                    <Box sx={{ flex: 1 }}>
                                        ...
                                        <Typography variant="caption" sx={{ color: '#cbd5e1', display: 'block', fontWeight: 800, mb: 1, letterSpacing: 0.5, fontFamily: 'monospace' }}>
                                            {patient.hospyn_id}
                                        </Typography>
                                        ...
                                        <Box sx={{ display: 'flex', gap: 1.5 }}>
                                            ...
                                            <Chip size="small" label="STABLE" sx={{ bgcolor: 'rgba(255,255,255,0.02)', color: '#cbd5e1', fontWeight: 900, height: 22, fontSize: '0.65rem' }} />
                                        </Box>
                                    </Box>

                                    {/* Metadata */}
                                    <Box sx={{ textAlign: 'right' }}>
                                        <Typography variant="caption" sx={{ color: '#cbd5e1', fontWeight: 800, fontSize: '0.7rem' }}>
                                            LAST SYNC
                                        </Typography>
                    ...
                    <>
                        ...
                        <Box sx={{ p: 4, flex: 1, overflowY: 'auto' }}>
                            ...
                            <Box sx={{ mb: 4, p: 3, bgcolor: 'rgba(99, 102, 241, 0.03)', borderRadius: '20px', border: '1px solid rgba(99, 102, 241, 0.1)' }}>
                                ...
                                <Typography variant="body2" sx={{ color: '#cbd5e1', lineHeight: 1.6, fontWeight: 500, fontFamily: 'Inter' }}>
                            ...
                            {/* Indicators */}
                            <Box sx={{ mb: 4 }}>
                                <Typography variant="overline" sx={{ color: '#cbd5e1', fontWeight: 900, mb: 2, display: 'block', letterSpacing: 1 }}>CLINICAL MARKERS</Typography>
