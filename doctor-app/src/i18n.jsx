...
const resources = {
    en: {
        translation: {
            ...
            "secure_access": "Secure access to the Hospain Clinic Terminal.",
    ...
    hi: {
        translation: {
            ...
            "secure_access": "Hospain क्लिनिक टर्मिनल तक सुरक्षित पहुंच।",
    ...
    te: {
        translation: {
            ...
            "secure_access": "Hospain క్లినిక్ టెర్మినల్‌కు సురక్షిత ప్రాప్యత.",
