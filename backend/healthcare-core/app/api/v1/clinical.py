...
async def get_clinical_timeline(
    ...
    for apt in appointments:
        ...
        timeline_items.append({
            ...
            "prescriptions": [{"name": apt.prescription, "dosage": "", "instructions": ""}] if apt.prescription else [],
            "lab_orders": [],
            "records": []
        })
    ...
    for record in records:
        secure_url = await storage.get_secure_url(record.file_url, expires_in=600) if record.file_url else None
