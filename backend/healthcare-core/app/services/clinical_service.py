...
class ClinicalService:
    ...
    async def complete_consultation(
        ...
        if walkin.queue_state != QueueState.in_consultation:
            raise ValueError(f"Walk-in request is not currently in consultation. State: {walkin.queue_state.value}")
        ...
        if not walkin.patient_id:
            ...
            if pat:
                ...
                raise ValueError("Consultation cannot be completed: Patient profile has not been created or linked yet.")
