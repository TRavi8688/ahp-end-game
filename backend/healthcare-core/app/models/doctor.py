...
from sqlalchemy import (
    ...
    UUID, Text, ForeignKey, Integer, func
)
...
class Doctor(Base):
    ...
    consultation_fee: Mapped[int] = mapped_column(Integer, default=0)  # in paisa / cents

    # Bio & Avatar
    bio: Mapped[str] = mapped_column(Text, nullable=True)
    avatar_url: Mapped[str] = mapped_column(String(500), nullable=True)  # MinIO object URL
