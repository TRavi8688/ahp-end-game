      ...
      <div className="w-64 bg-[#050b14] border-r border-white/5 flex flex-col z-10 relative hidden md:flex">
        <div className="p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-xl font-black text-white tracking-tight">HOSPIN.</h1>
          </div>
              ...
              <div className="mt-8 bg-white/[0.02] border border-white/5 rounded-3xl p-8 flex flex-col md:flex-row items-center gap-8 justify-between">
                 <div>
                    ...
                    <p className="text-sm text-slate-400 max-w-md">
                      Display this QR code at the counter. Patients can scan it with their Hospin app to instantly share their digital prescriptions.
                    </p>
                 </div>
             ...
             <div className="mb-6 relative">
               ...
               {dispenseReq.patient_id ? (
                 ...
                 <>
                   ...
                   <input className="w-full bg-white/5 border border-white/10 rounded-xl pl-12 pr-4 py-4 text-sm text-white focus:border-emerald-500 outline-none" placeholder="Search patient by Hospin ID or phone..." value={patientSearch} onChange={e=>setPatientSearch(e.target.value)} />
                   {patients.length > 0 && (
