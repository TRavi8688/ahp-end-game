      ...
      <div className="relative z-10 pt-12 pb-32 px-6 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-400 text-base max-w-2xl mx-auto leading-relaxed">
            These Terms of Service govern your use of the Hospin platform and services operated by <strong className="text-slate-300">Hospyn Technologies Pvt Ltd</strong>. By accessing or using Hospin, you agree to these terms.
          </p>
        ...
        <Section icon={Users} title="1. Platform Users & Eligibility" delay={0.1}>
          <p>The Hospin platform serves three distinct user categories, each subject to these terms:</p>
          <div className="grid md:grid-cols-3 gap-3 mt-4">
            {[
              { title: 'Patients', desc: 'Individuals seeking to book appointments, access health records, and use AI health assistance.' },
              { title: 'Doctors', desc: 'Registered medical practitioners using Hospin to manage patient appointments and records.' },
              { title: 'Hospital Owners / Admins', desc: 'Organisations or individuals who have registered their facility on the Hospin platform.' },
            ].map((u, i) => (
          ...
          <Clause number="1.3" title="Healthcare Provider Verification">
            Doctors and hospital administrators must complete identity and credential verification as required by Hospin before accessing provider-level features. Hospin reserves the right to reject or revoke access at its discretion.
          </Clause>
        </Section>

        <Section icon={FileText} title="2. Platform Usage Terms" delay={0.15}>
          <Clause number="2.1" title="Permitted Use">
            Hospin may only be used for lawful purposes in connection with healthcare management, appointment booking, health record storage, and related activities expressly supported by the platform.
          </Clause>
          ...
          <Clause number="2.3" title="AI Health Assistant">
            AI-generated responses are for general informational purposes only. They are not a substitute for professional medical advice. Hospin expressly disclaims liability for any decisions made based solely on AI-generated content.
          </Clause>
          <Clause number="2.4" title="Appointment Commitments">
            Patients who book appointments through Hospin are expected to attend or cancel at least 2 hours in advance. Repeated no-shows may result in account restrictions. Doctors and hospitals are expected to honour confirmed bookings.
          </Clause>
        </Section>

        <Section icon={CreditCard} title="3. Payment Terms" delay={0.2}>
          <Clause number="3.1" title="Payment Processing">
            All payments on Hospin are processed through RBI-compliant payment gateways. Hospin does not store raw card numbers or UPI credentials.
          </Clause>
          ...
          <Clause number="3.4" title="Failed Payments">
            In the event of a failed subscription payment, Hospin will notify you and allow a 7-day grace period before restricting provider-level features.
          </Clause>
        </Section>
        ...
        <Section icon={AlertTriangle} title="4. Account Suspension & Termination" delay={0.25}>
          ...
          <Clause number="4.2" title="By Hospin">
            Hospin may suspend or terminate your account immediately and without notice if: (a) you violate these Terms; (b) you engage in fraudulent or illegal activity; (c) your continued use poses a risk to other users or the platform; (d) required by law or regulatory order.
          </Clause>
          <Clause number="4.3" title="Effect of Termination">
            Upon termination, your right to use the platform ceases immediately. Data export requests must be submitted before account deletion. Hospin will honour such requests within 30 days subject to identity verification.
          </Clause>
        ...
        <Section icon={FileText} title="5. Intellectual Property" delay={0.3}>
          <p>
            All content, code, AI models, trademarks, and designs on the Hospin platform are the exclusive property of Hospyn Technologies Pvt Ltd or its licensors. Nothing in these Terms grants you a right to use our brand, logo, or proprietary technology outside the platform.
          </p>
          <p>
            Health records and personal data you upload remain your property. By uploading, you grant Hospin a limited, non-exclusive licence to process that data solely for the purposes described in the Privacy Policy.
          </p>
        </Section>
        ...
        <Section icon={AlertTriangle} title="6. Limitation of Liability" delay={0.35}>
          ...
          <p className="mt-3">
            Our aggregate liability for any claim arising out of or related to these Terms shall not exceed the total fees paid by you to Hospin in the 3 months preceding the claim.
          </p>
        </Section>
        ...
        <Section icon={FileText} title="8. Modifications to Terms" delay={0.45}>
          <p>
            Hospin reserves the right to modify these Terms at any time. Material changes will be communicated via in-app notification at least 15 days before they take effect. Your continued use of the platform after the effective date constitutes acceptance of the revised Terms.
          </p>
          <p className="mt-3">
