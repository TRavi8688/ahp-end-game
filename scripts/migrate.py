...
async def run_migrations():
    ...
    try:
        ...
        statements = [
            ...
            "ALTER TABLE doctors ADD COLUMN IF NOT EXISTS phone_number VARCHAR(50);",
            "ALTER TABLE doctors ADD COLUMN IF NOT EXISTS ahba_id VARCHAR(50);",
            "ALTER TABLE doctors ADD COLUMN IF NOT EXISTS certification_url VARCHAR(512);",
